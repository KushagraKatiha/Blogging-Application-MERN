...
function BlogPage() {
  ...
  return (
    <>
    <NavigationBar/>
    <div className='mt-5 px-44 bg-gunmetal w-full h-full overflow-auto flex flex-col gap-10 items-center justify-center pb-5'> 
                  ...
                  dummyBlog.map((blog, index) => (
                      <div className='shadow-3xl' key={index}>
                        <div key={index} className='bg-darkcyan p-5 rounded-md'>
                          ...
                          <div className='flex flex-col gap-2 mt-5'>
                            <button onClick={changeVisiblity} className='text-left bg-gunmetal text-white px-2 py-1 rounded-md w-fit'>view comments</button>
